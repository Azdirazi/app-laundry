            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-body my-3">
                        <form class="my-3" enctype="multipart/form-data" action="{{route('customer.updateCustomer',$customer->id)}}" method="post">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="col-md-9">
                                    <div class="form-check-inline my-1">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio4" name="gender" class="custom-control-input" value="gender" checked>
                                            <label class="custom-control-label" for="customRadio4">Laki - laki</label>
                                        </div>
                                    </div>
                                    <div class="form-check-inline my-1">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio5" name="gender" class="custom-control-input" value="gender">
                            ...
                            <div class="col-lg-12 col-12 mb-2">
                                ...
                                <div class="col-sm-20">
                                     <textarea class="col-lg-12" name="address" id="example-text-input" cols="20" rows="5" placeholder="Masukkan Alamat">{{ $customer->address}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12 col-12 mb-2">
