                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-body my-3">
                        <form class="my-3" enctype="multipart/form-data" action="">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="username">Tanggal<sup class="text-danger"></sup></label>
                                <input type="date" id="Nama Pelanggan" name="Nama Pelanggan" value="" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="username">Pengeluaran (Rp)<sup class="text-danger"></sup></label>
